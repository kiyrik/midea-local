    ...
    def __init__(
        ...
        super().__init__(
            ...
            attributes={
                ...
                DeviceAttributes.sys_heat_day_renew_power: None,
                DeviceAttributes.sys_heat_day_elec_consum: None,
                DeviceAttributes.sys_heat_day_copeer: None,
                DeviceAttributes.sys_instant_renew_power: None,
